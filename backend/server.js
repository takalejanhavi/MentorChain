...
// Connect to MongoDB
mongoose.connect(
  process.env.MONGODB_URI || 'mongodb+srv://janhavit:database@mernecom.igrid.mongodb.net/career-guidance?retryWrites=true&w=majority',
  {
